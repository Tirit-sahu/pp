   ...
   <body>
            ...
            <div class="border">
               <table  cellpadding="0" cellspacing="0" style="width:100%" >
                  ...
                  <?php                   
                  $unitRate = 0;
                  $unitRate = commonController::getStaticValueByMultiWhere('custom_unit_rates','rate',['partyId'=>$_GET['partyId'],'unitId'=>$row->unitId]);
                  ...
                  <b style="font-size: 12px;">Bal. Carret : {{ $balCarret }}</b>
               </table>
            </div>
