    ...
    <div class="container-fluid">
        ...
        <div class="breadcrumbs">
            <ul>
                ...
                <li>
                    <a href="index-2.html">Company Setting Master</a>                    
                </li>
            </ul>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-color">
                    <div class="box-title">
                        <h3>
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Company Setting Edit    
                        </h3>
                        ...
                        <form wire:submit.prevent="update" method="POST" enctype="multipart/form-data" class='form-horizontal form-column form-bordered'>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="logo" class="control-label col-sm-2">Logo <img src="{{ asset('storage/app/'.$logo) }}" alt="Hi"></label>
                                        <div class="col-sm-10">
