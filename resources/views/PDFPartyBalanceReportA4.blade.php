...
<head>
    ...
    <title>customer_balance_report_A4</title>
    <style>
    .border {
         position: fixed;
         top: 0;
...
<div class="border">
      ...
      <td   class="tt"colspan="2"><b>Customer Name</td>
      >
      <td   class="tt"><b>Address </td>
      <td   class="tt"><b>Mobile No</td>
      <td    class="tt" ><b>Bal Amt</td>
  </tr>
  <?php $totalAmt = 0; ?>
