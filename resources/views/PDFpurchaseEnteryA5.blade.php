...
<div class="border">
    ...
    <tr>
        ...
        <tr>
        <td  style='text-align:center;' colspan="5" ><b> {{ $comp->address }}<br>
Mo. :</b>{{ $comp->mobile }},{{ $comp->mobile2 }}<br>
<b>:- Kishan Purchase Bill:-</td>
        </tr>
        <tr>
            <td  colspan="2" class="t1"><b>Mr. : {{ isset($data->billPrintName) ? $data->billPrintName : commonController::getValueStatic('master_customer_suppliers','name','id',$data->partyId) }}</td>
...
Vehical No. :</td>
  ...
  @php
        ...
        @endforeach
        <tr>
            <td colspan="2" class="t2" style='text-align:right;'>Total Weight : {{ number_format($totalWeight,2) }}</td>
...
<tr>
    <td class="t5"></td>
    <td  colspan="4" class="t5"><b>Net Sale :</td>
