        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-color">
                    <div class="box-title">
                        <h3>
                            <i class="fa fa-list-alt" aria-hidden="true"></i> Purchase Payment Entry Report   
                        </h3>
                    ...
                    <div class="box-content">
                        ...
                        <div class="box-content nopadding" style="overflow: scroll;">
                            ...
                            <!-- Datatable Filter -->
                            <form action="{{ url('/report-purchase-payment-entries') }}" method="GET">
                            <table class="table">
                                <thead>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/report-purchase-payment-entries') }}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Reset</a>
                                    </td>
                                  </tr>
                                    ...
                                    @foreach($purchase_payment_entries as $row)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-primary" rel="tooltip" title="Delete">
                                                    A6
                                                </a>
                                                
                                                <a href="#" class="btn btn-warning" rel="tooltip" title="Delete">
                                                    A6
                                                </a>
                                            ...
                                            <td class='hidden-480'>
                                                ...
                                                <a href="{{ url('paymentPurchaseReceiveReportDetails') }}?date={{ $row->date }}&partyId={{ $row->partyId }}" class="btn btn-inverse btn--icon" rel="tooltip" title="View">
