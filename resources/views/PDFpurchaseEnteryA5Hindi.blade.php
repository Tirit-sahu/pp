...
<div class="border">
    ...
    <tr>
            ...
            {{ isset($comp->slogHindi) ? $comp->slogHindi : '' }}
            </td>  
        </tr>
...
<b>:- किसान बीजक:-</td>
        ...
        <tr>
            ...
            <td  colspan="3" style='text-align:right;' class="t1">बिल की तारीख: {{ date('d-m-Y',strtotime($data->date)) }}<br>
            गाडी नं. :</td>
        </tr>
  <tr>
      <td  class="tt">क्र.</td>
...
<b><br>बकाया केरेट : <?php echo  CustomerSupplierCarretLedger::getPartyCarretBalanceByDateStatic($data->partyId, $data->date ) ?></b>
    </table>
