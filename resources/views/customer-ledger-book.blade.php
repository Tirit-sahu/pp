        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="box box-color">
                    <div class="box-title">
                        <h3>
                            <i class="fa fa-list-alt" aria-hidden="true"></i>Party Ledger Book
                        </h3>
                    </div>
                    <div class="box-content">
                        ...
                        <div class="box-content nopadding" style="overflow: scroll;">
                            ...
                            <!-- Datatable Filter -->
                            <form action="{{ url('/ledger-book') }}" method="GET">
                            <table class="table">
                                <thead>
                                  <tr>
                                ...
                                <tbody>
                                  <tr>
                                    <td>
                                        <input type="text" value="{{ $fromDate }}" class="form-control datemask" name="fromDate" placeholder="DD-MM-YYYY">                 
                                    </td>
                                    
                                    <td>
                                        <input type="text" value="{{ $toDate }}" class="form-control datemask" name="toDate" placeholder="DD-MM-YYYY">                 
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/ledger-book') }}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Reset</a>
                                    </td>
                                  </tr>
                            ...
                            <table id="pagingFalseDataTable" class="table table-hover table-nomargin table-bordered">
                                ...
                                <tbody>
                                    <?php 
                                    $currentBal = 0;
                                        $balanceType = commonController::getValueStatic('master_customer_suppliers','balanceType','id',$partyId);         
                                        if($balanceType=='CR'){
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold;">
                                                ...
                                                if($row->particular == 'Sale'){
                                                    echo ':';
                                                    echo '<br>';
                                                    $sql = "SELECT * FROM `customer_sales` WHERE companyId=1 AND date BETWEEN '$row->date' AND '$row->date' AND partyId=$row->partyId";
                                                    ...
                                                    foreach ($LedgerItemDetails as $itemDetail) {
                                                        ...
                                                        $unitRate = 0;
                                                        $unitRate = commonController::getStaticValueByMultiWhere('custom_unit_rates','rate',['partyId'=>$row->partyId,'unitId'=>$itemDetail->unitId]);
